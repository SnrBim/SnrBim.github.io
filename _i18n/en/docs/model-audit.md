...
Path to save the new report. Generated by default as:
...
> The path is saved between sessions.
...
| 18 | ProjectInfo | pi | ProjectInformation parameters: all parameters on the element |
...
| 24 | Sheets | sh | Sheets: Id, name, number, IsPlaceholder, title block + custom parameters |
| 25 | TitleBlocks | tb | Title block types and assigned sheets |
| 26 | Viewports | vp | Viewports: type, view, sheet |
| 27 | Views | vw | All views with 32 properties (template, scale, far clip, ViewRange, etc.) |
