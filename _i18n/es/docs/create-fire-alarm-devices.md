# Create Fire Alarm Devices — Colocación automática de dispositivos de alarma contra incendios
{: .no_toc }
...
El comando coloca automáticamente dispositivos de alarma contra incendios en espacios MEP seleccionados: detectores de techo en una cuadrícula y dispositivos de pared (sirena, pulsador) en puertas.
...
- Coloca un pulsador en cada puerta exterior
- Omite dispositivos ya colocados por el comando (idempotencia)
- Genera un informe de texto con los resultados
...
3. Opcionalmente ajuste los nombres de familia/tipo y los parámetros de altura
4. Pulse **Run**
...
| *otros* | optico | — |
| *cualquier con puerta exterior* | — | pulsador |
...
**Manual height (mm)** — altura sobre el suelo del espacio usada en modo manual.
...
Un pulsador se coloca en la pared junto a cada puerta exterior a 1400 mm de altura. El lado preferido es el de las bisagras; si no hay espacio, se usa el lado de la manilla. La orientación mira hacia el interior del espacio.

## Salida

Al finalizar, el comando muestra un informe:
- Recuento de dispositivos colocados por familia/tipo
- Recuento de puntos omitidos (ya ocupados)
